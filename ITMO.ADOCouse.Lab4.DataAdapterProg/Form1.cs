...
namespace ITMO.ADOCouse.Lab4.DataAdapterProg
{
    public partial class Form1 : Form
    {
        ...
        private SqlConnection NorthwindConnection = new SqlConnection(@"Data Source=LAPTOP-54GSHBB5\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True");
